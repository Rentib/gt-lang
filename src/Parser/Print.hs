...
instance Print (Parser.Abs.Decl' a) where
  prt i = \case
    Parser.Abs.DNoInit _ id_ type_ -> prPrec i 0 (concatD [doc (showString "var"), prt 0 id_, doc (showString ":"), prt 0 type_, doc (showString ";")])
    Parser.Abs.DInit _ id_ expr -> prPrec i 0 (concatD [doc (showString "var"), prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
    Parser.Abs.DConst _ id_ expr -> prPrec i 0 (concatD [doc (showString "const"), prt 0 id_, doc (showString "="), prt 0 expr, doc (showString ";")])
...
instance Print (Parser.Abs.Instr' a) where
  prt i = \case
    ...
    Parser.Abs.IDo _ instr expr -> prPrec i 0 (concatD [doc (showString "do"), prt 0 instr, doc (showString "while"), doc (showString "("), prt 0 expr, doc (showString ")"), doc (showString ";")])
...
instance Print (Parser.Abs.Expr' a) where
  prt i = \case
    ...
    Parser.Abs.EAnd _ expr1 expr2 -> prPrec i 3 (concatD [doc (showString "("), prt 3 expr1, doc (showString "&&"), prt 4 expr2, doc (showString ")")])
    Parser.Abs.EOr _ expr1 expr2 -> prPrec i 2 (concatD [doc (showString "("), prt 2 expr1, doc (showString "||"), prt 3 expr2, doc (showString ")")])
...
instance Print (Parser.Abs.UnaryOp' a) where
  prt i = \case
    ...
    Parser.Abs.OpUnaryTilde _ -> prPrec i 0 (concatD [doc (showString "~")])
